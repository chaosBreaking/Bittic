...
const DAD=module.exports=function Tac(prop) {
...
DAD._init=async function(){
  ...
  if (wo.Config.consensus==='ConsPot'){
    wo.Config.GENESIS_EPOCHE= new Date('2018-06-10T13:53:00.000Z')//Date.time2epoche() // 为了方便开发，暂不使用固定的创世时间，而是生成当前时刻之后的第一个0秒，作为创世时间
  }
...
DAD.createGenesis=async function(){
  ...
  await wo.Account.addOne({Account:{ balance: 100000, address:"Tg2WAh2VYT71R1idZ9dQbzukvkNNwB1MBf" }})
