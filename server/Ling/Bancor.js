...
//    await this.addMe()
    ...
    return { money:option.money, token:option.token, poolBalance:this.poolBalance+option.money, poolSupply:this.poolSupply+option.token }
  }
}
